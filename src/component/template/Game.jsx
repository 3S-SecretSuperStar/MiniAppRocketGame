        ...
        if (isMounted) {
          try {
            setPlanetPos((prevPos) => ({
              x: prevPos.x > window.innerWidth ? -300 : prevPos.x + window.innerWidth / 10000, // Create a new x position
              y: prevPos.y > window.innerHeight ? -300 : prevPos.y + window.innerHeight / 10000, // Create a new y position
            }));
