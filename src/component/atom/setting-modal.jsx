...
const SettingModal = ({ children, icon, title, isOpen, setIsOpen }) => {
    ...
    return (
        ...
        >
            <div
                className={
                    `absolute bottom-0 rounded-tl-[10px] h-screen rounded-tr-[10px] w-full bg-gradient-to-b from-[#480B97] to-[#BA2BA1]
