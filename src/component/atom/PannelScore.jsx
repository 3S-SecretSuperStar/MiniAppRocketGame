...
const PannelScore = ({ img, text2, text3, className = "" }) => {
  return (
    <div className={cn("flex flex-row bg-white_20 rounded-lg gap-2 py-1 px-[10.5px] max-w-32 text-base leading-5 font-roboto text-white justify-center", className)}>
